...
import sistersart.model.binding.ArticleAddBindingModel;
import sistersart.repository.ArticleRepository;
...
public class ArticleEditValidator implements Validator {
    ...
    public ArticleEditValidator(ArticleRepository articleRepository) {
